...
// Tablespaces - это название функции, которая обрабатывает маршрут /tablespaces
func Tablespaces(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "tablespaces", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// Monitoring - это название функции, которая обрабатывает маршрут /monitoring
func Monitoring(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "monitoring", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// AccessControl - это название функции, которая обрабатывает маршрут /access_control
func AccessControl(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "access_control", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// Backup обработчик маршрута /backup
func Backup(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "backup", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// PhysicalReplication обработчик маршрута /physical_replication
func PhysicalReplication(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "physical_replication", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// LogicalReplication обработчик маршрута /logical_replication
func LogicalReplication(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "logical_replication", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
...
// General обработчик маршрута /general
func General(w http.ResponseWriter, r *http.Request) {
	// Полные пути к шаблонам
	indexPath := filepath.Join("templates", "general", "index.html")
	navbarPath := filepath.Join("templates", "navbar.html")
	footerPath := filepath.Join("templates", "footer.html")
